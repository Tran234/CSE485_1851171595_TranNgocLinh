...
<div id="demo" class="carousel slide slide1" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="img/bannertq4.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img src="img/sslab.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img src="img/rivf-gala.jpg" alt="Third slide">
            </div>
        </div>
    ...
    <div class="footer">
        <div class="row">
                <div class="anhdiachi">
                    <img src="img/TLU-map.jpg" alt="" srcset="">
                </div>
                <div class="diachi">
